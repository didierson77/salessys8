...
exports.CategoriasRoutingModule = void 0;
...
var routes = [
    {
        path: '',
        children: [
            { path: 'catalogo', component: listado_categorias_component_1.ListadoCategoriasComponent, data: { titulo: 'Catálogo de Categorias' } },
