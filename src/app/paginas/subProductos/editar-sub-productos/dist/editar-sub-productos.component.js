...
exports.EditarSubProductosComponent = void 0;
...
var EditarSubProductosComponent = /** @class */ (function () {
    function EditarSubProductosComponent(_subProductoService, _usuarioService, _categoriasService, rutaActiva, router, _subirArchivoService) {
    ...
    EditarSubProductosComponent.prototype.ngOnInit = function () {
        var _this = this;
    ...
    EditarSubProductosComponent.prototype.cargarProducto = function (id) {
        var _this = this;
        this._subProductoService.getSubProductoEspecif(id).subscribe(function (resp) {
            var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k;
            console.log(resp);
            _this.producto = resp.subproducto;
            ...
            _this.imagen = ((_k = _this.producto) === null || _k === void 0 ? void 0 : _k.img) || '';
        });
    };
    // calcular() {
    ...
    //   }
    // }
    EditarSubProductosComponent.prototype.guardar = function () {
        var _this = this;
        if (this.forma.valid) {
            ...
            this._subProductoService.actualizarSubProducto(this.producto)
    ...
    EditarSubProductosComponent.prototype.seleccionImagen = function (event) {
        var _this = this;
        if (!event) {
    ...
    EditarSubProductosComponent.prototype.cambiarImagen = function () {
        var _this = this;
    ...
    EditarSubProductosComponent = __decorate([
        core_1.Component({
            selector: 'app-editar-sub-productos',
            templateUrl: './editar-sub-productos.component.html',
            styles: []
        })
    ], EditarSubProductosComponent);
    return EditarSubProductosComponent;
}());
exports.EditarSubProductosComponent = EditarSubProductosComponent;
