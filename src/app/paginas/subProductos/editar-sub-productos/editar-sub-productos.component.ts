...
export class EditarSubProductosComponent implements OnInit {
  ...
  cargarProducto(id: string) {
    this._subProductoService.getSubProductoEspecif(id).subscribe((resp: any) => {
      console.log(resp);
      this.producto = resp.subproducto;
